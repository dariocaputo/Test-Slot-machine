...
function Wrapper ()
{
	...
	*/
	Wrapper.PAYLINES = [
		[3, 4, 5], // line id 0    medio hor
		[0, 1, 2], // line id 1    arriba hor
		[6, 7, 8], // line id 2    abajo hor
		[0, 4, 8], // line id 3    diagonal Desc
		[6, 4, 2]  // line id 4    diagonal Asc
	];

	Wrapper.PAYTABLE = [
		{ symbol: "a", prize:50 }, //trebol
		{ symbol: "b", prize:45 }, //campana
		{ symbol: "c", prize:40 }, //frutilla
		{ symbol: "d", prize:35 }, //uva
		{ symbol: "e", prize:30}  //cereza
	];
}
